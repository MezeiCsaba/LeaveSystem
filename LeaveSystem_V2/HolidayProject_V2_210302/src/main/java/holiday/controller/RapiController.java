...
public class RapiController {
	...
	public ResponseEntity<String> postData(@RequestBody List<Event> rEvents, Authentication authentication)
		...
		// ha van új szabadságigény és van jóváhagyó , levelet üldünk a jóváhagyónak
		if (newEventCounter>0 && authUser.getApproverId() != null && authUser.getApproverId() >= 0) eventService.sendEmailFromNewEvent(authUser, newEventCounter);
	...
	@PostMapping("/getdata")
	public ResponseEntity<String> getData(@RequestBody String selector, Authentication authentication) throws JsonProcessingException {
