...
textCtx.innerText = "  Szabadságok: "+ (leaveCounter) +" / " + sumLeave ;
...
function setDateAttr(id) {
	...
	if ((sumLeave-leaveCounter == .5) && (color == "white")) {
		color = 'lightskyblue';
		eventList.push({"id":-1,"startDate":date1,"user":null,"approved":0,"duration":2})
    ...
    switch (color) {
        ...
        case 'lightskyblue':  // délelőtt (fél nap szabi)
            ...
            break;
        case 'yellow': // délután (fél nap szabi)
			thisCell.style.border = "1px solid black"
